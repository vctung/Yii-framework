          ...
          <div class="row item-blocks-connected">
            ...
            <div class="col-xs-12">
              <a class="item-block" href="job-detail.html">
                <header>
                  <img src="<?php echo siteThemes(); ?>assets/img/logo-google.jpg" alt="">
                  <div class="hgroup">
            ...
            <div class="col-xs-12">
              <a class="item-block" href="job-detail.html">
                <header>
                  <img src="<?php echo siteThemes(); ?>assets/img/logo-linkedin.png" alt="">
                  <div class="hgroup">
            ...
            <div class="col-xs-12">
              <a class="item-block" href="job-detail.html">
                <header>
                  <img src="<?php echo siteThemes(); ?>assets/img/logo-envato.png" alt="">
                  <div class="hgroup">
            ...
            <div class="col-xs-12">
              <a class="item-block" href="job-detail.html">
                <header>
                  <img src="<?php echo siteThemes(); ?>assets/img/logo-facebook.png" alt="">
                  <div class="hgroup">
            ...
            <div class="col-xs-12">
              <a class="item-block" href="job-detail.html">
                <header>
                  <img src="<?php echo siteThemes(); ?>assets/img/logo-microsoft.jpg" alt="">
                  <div class="hgroup">
      ...
      <!-- Facts -->
      <section class="bg-img bg-repeat no-overlay section-sm" style="background-image: url(<?php echo siteThemes(); ?>assets/img/bg-pattern.png)">
        <div class="container">
      ...
      <section>
        <div class="container">
          ...
          <div class="col-sm-12 col-md-6 hidden-xs hidden-sm">
            <br>
            <img class="center-block" src="<?php echo siteThemes(); ?>assets/img/how-it-works.png" alt="how it works">
          </div>
      ...
      <!-- Newsletter -->
      <section class="bg-img text-center" style="background-image: url(<?php echo siteThemes(); ?>assets/img/bg-facts.jpg)">
        <div class="container">
