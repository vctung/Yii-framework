...
$this->pageTitle=Yii::app()->name . ' - Add New User';
				...
				<?php $form=$this->beginWidget('CActiveForm', array(
			     ...
			     ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<?php echo $form->passwordField($model,'password', array('class' => "form-control", 'placeholder' => 'Password for Login')); ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<?php echo $form->textField($model,'email', array('class' => "form-control", 'value' => 'Email of User ')); ?>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<button class="btn btn-yellow btn-block" type="submit">
								Add User <i class="icon-circle-arrow-right"></i>
							</button>
						</div>
					</div>
