				...
				<?php $form=$this->beginWidget('CActiveForm', array(
			     ...
			     ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<?php echo $form->textField($model,'name', array('class' => "form-control", 'placeholder' => 'Partner name')); ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<?php echo $form->textField($model,'link', array('class' => "form-control", 'value' => 'http://')); ?>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<button class="btn btn-yellow btn-block" type="submit">
								Add Partner <i class="icon-circle-arrow-right"></i>
							</button>
						</div>
					</div>
