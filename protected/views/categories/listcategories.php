					...
					<?php foreach ( $categories as $value) { ?>
						<tr>
							...
							<div class="visible-md visible-lg hidden-sm hidden-xs">
								<?php echo CHtml::link(" <i class=\"icon-edit\"></i>",array('categories/editcategory', 'catid'=>$value['id'],),
								 array(
									 'class'=>'btn btn-green tooltips',
									 'confirm' => 'Are you sure to Edit ?',
								)); ?>

								 <?php echo CHtml::link(" <i class=\"icon-remove icon-white\"></i>",array('categories/deletecategory', 'catid'=>$value['id'],),
								 array(
